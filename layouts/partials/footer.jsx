...
const Footer = () => {
  return (
    <>
      <div className="flex items-center justify-center lg:justify-end p-4 mt-16 lg:mt-0">
        <div className="flex flex-col items-center w-full max-w-xs p-4 bg-white rounded-3xl lg:flex-row">
          <div
            className="-mt-28 lg:-my-16 lg:-ml-32"
            style={{ clipPath: 'url(#roundedPolygon)' }}
          >
            <img className="w-auto h-48" src="" alt="Bakare Abiola" />
          </div>
      ...
      <div className="inline-flex w-full justify-end p-4 ">
        <div className="flex items-center justify-center flex-shrink-0  rounded-xl">
          <div className="flex flex-row items-center  mt-2  ">
            <h2 className="text-xs font-medium text-slate-400">Made with..</h2>
